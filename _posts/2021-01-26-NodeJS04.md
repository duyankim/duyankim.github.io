...
description: ejs에 대해서
date: "2021-01-26 20:15:08 +0000"
categories: [Framework, Node.js]
tags: [template, ejs, app.render, app.set, path.join, static, node, Udemy, NodeJS]
image:
  path: /img/header/javascript.jpg
---
...
<!-- TODO: 이미지 복원 필요 — ![결과물](/assets/images/20210126-1.jpg) -->
